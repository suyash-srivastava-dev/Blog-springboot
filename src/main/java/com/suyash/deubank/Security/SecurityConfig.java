package com.suyash.deubank.Security;

import com.suyash.deubank.Filter.CustomAuthenticationFilter;
import com.suyash.deubank.Filter.CustomAuthorizationFilter;
...
//        http.authorizeHttpRequests().antMatchers(POST,"/v1/api/role/**").hasAnyAuthority("SuperAdmin");
